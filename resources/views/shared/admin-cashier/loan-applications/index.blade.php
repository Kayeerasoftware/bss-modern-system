<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-3 md:p-6">
    ...
    <div class="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 rounded-2xl shadow-lg border border-blue-100 overflow-hidden mb-4">
        <form method="GET" action="{{ route((request()->routeIs('cashier.*') ? 'cashier' : 'admin') . '.loan-applications.index') }}">
                ...
                <div class="bg-white/80 rounded-xl p-2.5 border border-blue-100">
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-2">
                        ...
                        <div class="md:col-span-3 flex gap-1.5">
                            ...
                            <a href="{{ route((request()->routeIs('cashier.*') ? 'cashier' : 'admin') . '.loan-applications.index') }}" class="px-2 py-1.5 text-xs bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 rounded-lg hover:shadow-md transition-all duration-300 font-semibold">
