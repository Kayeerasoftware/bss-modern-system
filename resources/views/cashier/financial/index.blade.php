                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gradient-to-r hover:from-green-50 hover:to-emerald-50 transition-all duration-200">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center gap-2">
                                @if($transaction->member && $transaction->member->profile_picture_url)
                                    <img src="{{ $transaction->member->profile_picture_url }}" class="w-10 h-10 rounded-full object-cover ring-2 ring-green-500 ring-offset-2" alt="">
                                @else
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gradient-to-r hover:from-red-50 hover:to-rose-50 transition-all duration-200">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center gap-2">
                                @if($transaction->member && $transaction->member->profile_picture_url)
                                    <img src="{{ $transaction->member->profile_picture_url }}" class="w-10 h-10 rounded-full object-cover ring-2 ring-red-500 ring-offset-2" alt="">
                                @else
