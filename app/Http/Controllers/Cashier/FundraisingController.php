...
class FundraisingController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('cashier.fundraising.index', compact('fundraisings'));
    }
    ...
    public function campaigns(Request $request)
    {
        ...
        return view('cashier.fundraising.campaigns', compact('campaigns'));
    }

    public function create()
    {
        return view('cashier.fundraising.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('cashier.fundraising.index')->with('success', 'Fundraising campaign created successfully');
    }

    public function show($id)
    {
        $fundraising = Fundraising::with(['contributions', 'expenses'])->findOrFail($id);
        return view('cashier.fundraising.show', compact('fundraising'));
    }
    ...
    public function contributions($id)
    {
        ...
        return view('cashier.fundraising.contributions', compact('fundraising'));
    }
    ...
    public function contributionsCreate($id)
    {
        ...
        return view('cashier.fundraising.contributions-create', compact('fundraising', 'contributors', 'paymentMethods', 'receiptIssuers', 'members', 'membersLite', 'memberSummaries', 'internalPaymentMethodId'));
    }
    ...
    public function contributionsStore(Request $request, $id)
    {
        ...
        return redirect()
            ->route('cashier.fundraising.contributions', $fundraising->id)
    ...
    public function contributionsShow($id, $contributionId)
    {
        ...
        return view('cashier.fundraising.contributions-show', compact('fundraising', 'contribution'));
    }
    ...
    public function contributionsEdit($id, $contributionId)
    {
        ...
        return view('cashier.fundraising.contributions-edit', compact('fundraising', 'contribution', 'contributors', 'paymentMethods', 'receiptIssuers', 'members', 'membersLite', 'memberSummaries', 'fundingSource', 'internalPaymentMethodId'));
    }
    ...
    public function contributionsUpdate(Request $request, $id, $contributionId)
    {
        ...
        return redirect()
            ->route('cashier.fundraising.contributions.show', [$fundraising->id, $contribution->id])
    ...
    public function contributionsPrint($id, $contributionId)
    {
        ...
        return view('cashier.fundraising.contributions-print', compact('fundraising', 'contribution'));
    }
    ...
    {
        $fundraising = Fundraising::findOrFail($id);
        return view('cashier.fundraising.edit', compact('fundraising'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('cashier.fundraising.index')->with('success', 'Fundraising campaign updated successfully');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('cashier.fundraising.index')->with('success', 'Fundraising campaign deleted successfully');
    }
