...
<div class="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 p-3 md:p-6">
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <h2 class="text-2xl md:text-3xl font-bold bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">Add New User</h2>
            <p class="text-gray-600 text-sm">Create a new system user account</p>
        </div>
    </div>

    <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data" class="max-w-4xl mx-auto">
        @csrf
            ...
            <div class="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 p-8 text-center">
                <div class="flex justify-center mb-4">
                    <div class="relative group">
                        <div class="w-24 h-24 rounded-full bg-white flex items-center justify-center overflow-hidden shadow-2xl">
                            <img id="preview" src="" alt="" class="w-full h-full object-cover hidden">
                            <i id="placeholder" class="fas fa-user-shield text-indigo-600 text-4xl"></i>
                        </div>
                ...
                <h3 class="text-white text-xl font-bold">System User Account</h3>
                <p class="text-white/80 text-sm">Complete the form below</p>
            </div>
