<aside class="sidebar w-36 bg-gradient-to-b from-blue-50 to-blue-100 dark:from-gray-800 dark:to-gray-900 border-r border-blue-200 dark:border-gray-700 fixed left-0 top-12 h-[calc(100vh-3rem)] overflow-hidden transition-all duration-300 lg:translate-x-0 z-10 flex flex-col"
    ...
    <div class="pt-1 px-2 profile-section">
        <div class="p-2 border-b border-blue-200">
            <div class="flex flex-col items-center py-1">
                ...
                <p class="text-xs font-semibold text-gray-800 text-center" x-text="adminProfile.name">TD</p>
                <p class="text-[10px] text-gray-500" x-text="adminProfile.role">Technical Director</p>
            </div>
    ...
    <div class="flex-1 scrollable-content">
        ...
        <nav class="space-y-1 sidebar-nav" id="sidebarNav">
            <a href="{{ route('td.dashboard') }}" class="nav-item flex items-center space-x-2 px-2 py-2 rounded-lg transition text-xs {{ request()->routeIs('td.dashboard') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-orange-50 hover:text-orange-600' }}" data-search="dashboard">
                <i class="fas fa-tachometer-alt w-3 text-xs"></i><span>Dashboard</span>
            </a>
            <a href="{{ route('td.members.index') }}" class="nav-item flex items-center space-x-2 px-2 py-2 rounded-lg transition text-xs {{ request()->routeIs('td.members.*') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-orange-50 hover:text-orange-600' }}" data-search="members">
                <i class="fas fa-users w-3 text-xs"></i><span>Members</span>
            </a>
            <a href="{{ route('td.loans.index') }}" class="nav-item flex items-center space-x-2 px-2 py-2 rounded-lg transition text-xs {{ request()->routeIs('td.loans.*') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-orange-50 hover:text-orange-600' }}" data-search="loans">
                <i class="fas fa-money-bill-wave w-3 text-xs"></i><span>Loans</span>
            </a>
            <a href="{{ route('td.projects.index') }}" class="nav-item flex items-center space-x-2 px-2 py-2 rounded-lg transition text-xs {{ request()->routeIs('td.projects.*') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-orange-50 hover:text-orange-600' }}" data-search="projects">
                <i class="fas fa-project-diagram w-3 text-xs"></i><span>Projects</span>
            </a>
            <a href="{{ route('td.photos.index') }}" class="nav-item flex items-center space-x-2 px-2 py-2 rounded-lg transition text-xs {{ request()->routeIs('td.photos.*') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-orange-50 hover:text-orange-600' }}" data-search="photos gallery">
                <i class="fas fa-images w-3 text-xs"></i><span>Photos</span>
            </a>
            <a href="{{ route('td.reports.index') }}" class="nav-item flex items-center space-x-2 px-2 py-2 rounded-lg transition text-xs {{ request()->routeIs('td.reports.*') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-orange-50 hover:text-orange-600' }}" data-search="reports">
        ...
        <div class="mt-4 pt-4 border-t border-blue-200">
            ...
            <a href="{{ route('td.profile') }}" class="nav-item flex items-center space-x-2 px-2 py-2 rounded-lg transition text-xs text-gray-700 hover:bg-orange-50 hover:text-orange-600">
        ...
        <div class="flex justify-center">
            <div class="w-80 space-y-2">
                ...
                <div class="flex gap-2 pt-1">
                    <a href="{{ route('td.profile') }}" @click="showProfileModal = false" 
