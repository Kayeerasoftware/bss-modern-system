...
<div class="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 p-6">
    <div class="max-w-6xl mx-auto">
        <div class="flex items-center gap-4 mb-6">
            <a href="{{ route('member.dashboard') }}" class="p-3 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all">
        ...
        <form action="{{ route('member.bio-data.store') }}" method="POST" class="bg-white rounded-2xl shadow-xl p-8 space-y-6">
            @csrf
            ...
            <div class="flex gap-4 pt-4">
                ...
                <a href="{{ route('member.dashboard') }}" class="px-6 py-4 bg-gray-200 text-gray-700 rounded-xl hover:shadow-lg transition-all font-bold">
