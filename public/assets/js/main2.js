...
function adminPanel() {
    return {
        ...
        init() {
            ...
            console.log('Init: members loaded', this.members.length);
            console.log('Init: filteredMembersChat', this.filteredMembersChat.length);
        ...
        filterMembersForChat() {
            console.log('Filtering - chatFilter:', this.chatFilter, 'members:', this.members.length);
        ...
        selectMemberChat(member) {
            console.log('selectMemberChat called with:', member);
            if (!member) {
            ...
            console.log('selectedMemberChat set to:', this.selectedMemberChat);
            this.$nextTick(() => {
        ...
        async loadMembers() {
            try {
                ...
                this.members = Array.isArray(data.members) ? data.members.filter(m => m.id !== this.currentUserId) : [];
                this.filteredMembers = this.members;
