...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-3 md:p-6">
    ...
    <div class="mb-4 md:mb-6">
        <div class="flex items-center gap-2 md:gap-4">
            <div class="relative">
                <div class="absolute inset-0 bg-gradient-to-r from-red-600 to-rose-600 rounded-xl md:rounded-2xl blur-xl opacity-50"></div>
                <div class="relative bg-gradient-to-br from-red-600 to-rose-600 p-2 md:p-4 rounded-xl md:rounded-2xl shadow-xl">
                    <i class="fas fa-arrow-up text-white text-xl md:text-3xl"></i>
                </div>
            </div>
            <div>
                <h1 class="text-xl md:text-3xl font-bold bg-gradient-to-r from-red-600 via-rose-600 to-pink-600 bg-clip-text text-transparent mb-1 md:mb-2">Withdrawals</h1>
                <p class="text-gray-600 text-xs md:text-sm font-medium">View member withdrawals</p>
            </div>
        </div>
    </div>
    ...
    <div class="relative h-2 bg-gray-200 rounded-full overflow-visible mb-4 md:mb-6">
        <div class="h-full bg-gradient-to-r from-red-500 to-rose-500 rounded-full animate-slide-right"></div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gradient-to-r hover:from-red-50 hover:to-rose-50 transition-all duration-200">
                        ...
                        <td class="px-4 py-3 text-sm text-gray-600">
                            {{ Str::limit($withdrawal->description ?? 'N/A', 50) }}
                        </td>
                    </tr>
                    @empty
                    <tr>
