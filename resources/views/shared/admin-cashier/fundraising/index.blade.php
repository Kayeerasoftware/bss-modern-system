            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gradient-to-r from-purple-50 via-pink-50 to-orange-50">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Contributions</th>
                    ...
                    <tr class="hover:bg-gradient-to-r hover:from-purple-50 hover:to-pink-50 transition-all duration-200">
                        ...
                        <td class="px-4 py-3 whitespace-nowrap">
                            <div class="flex items-center gap-2">
                                <span class="font-bold text-indigo-600">{{ number_format($fund->contributions_count ?? 0) }}</span>
                                <a href="{{ route((request()->routeIs('cashier.*') ? 'cashier' : 'admin') . '.fundraising.contributions', $fund->id) }}" class="px-3 py-1.5 text-xs font-bold text-white bg-indigo-600 hover:bg-indigo-700 rounded-lg transition-all transform hover:scale-105">
                        ...
                        <td class="px-4 py-3 whitespace-nowrap text-center">
                            <div class="flex justify-center gap-1">
                                <a href="{{ route((request()->routeIs('cashier.*') ? 'cashier' : 'admin') . '.fundraising.show', $fund->id) }}" class="p-2 text-blue-600 hover:bg-blue-100 rounded-lg transition-all transform hover:scale-110" title="View">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route((request()->routeIs('cashier.*') ? 'cashier' : 'admin') . '.fundraising.edit', $fund->id) }}" class="p-2 text-yellow-600 hover:bg-yellow-100 rounded-lg transition-all transform hover:scale-110" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route((request()->routeIs('cashier.*') ? 'cashier' : 'admin') . '.fundraising.destroy', $fund->id) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
