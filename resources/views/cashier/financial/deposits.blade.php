    ...
    <div class="mb-4 md:mb-6">
        <div class="flex items-center gap-2 md:gap-4">
            ...
            <div>
                ...
                <p class="text-gray-600 text-xs md:text-sm font-medium">View member deposits and contributions</p>
            </div>
        </div>
    </div>
                    ...
                    <tr class="hover:bg-gradient-to-r hover:from-green-50 hover:to-emerald-50 transition-all duration-200">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center gap-2">
                                @if($deposit->member && $deposit->member->profile_picture_url)
                                    <img src="{{ $deposit->member->profile_picture_url }}" class="w-10 h-10 rounded-full object-cover ring-2 ring-green-500 ring-offset-2" alt="">
                                @else
                        ...
                        <td class="px-4 py-3 text-sm text-gray-600">
                            {{ Str::limit($deposit->description ?? 'N/A', 50) }}
                        </td>
                    </tr>
                    @empty
                    <tr>
