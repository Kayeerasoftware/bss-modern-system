<aside class="sidebar w-36 bg-gradient-to-br from-violet-50 via-purple-50 to-indigo-50 dark:from-gray-800 dark:to-gray-900 border-r border-violet-200 dark:border-gray-700 fixed left-0 top-12 h-[calc(100vh-3rem)] overflow-hidden transition-all duration-300 lg:translate-x-0 z-10 flex flex-col shadow-lg"
    ...
    <div class="flex-1 scrollable-content">
        ...
        <nav class="space-y-1 sidebar-nav" id="sidebarNav">
            <a href="{{ route('cashier.dashboard') }}" class="nav-item flex items-center space-x-2 px-2 py-2 rounded-lg transition text-xs {{ request()->routeIs('cashier.dashboard') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-orange-50 hover:text-orange-600' }}" data-search="dashboard">
                <i class="fas fa-tachometer-alt w-3 text-xs"></i><span>Dashboard</span>
            </a>
            <a href="{{ route('cashier.members.index') }}" class="nav-item flex items-center space-x-2 px-2 py-2 rounded-lg transition text-xs {{ request()->routeIs('cashier.members.*') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-orange-50 hover:text-orange-600' }}" data-search="members">
                <i class="fas fa-users w-3 text-xs"></i><span>Members</span>
            </a>
            <a href="{{ route('cashier.transactions.index') }}" class="nav-item flex items-center space-x-2 px-2 py-2 rounded-lg transition text-xs {{ request()->routeIs('cashier.transactions.*') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-orange-50 hover:text-orange-600' }}" data-search="transactions">
                <i class="fas fa-exchange-alt w-3 text-xs"></i><span>Transactions</span>
            </a>
            <a href="{{ route('cashier.deposits.index') }}" class="nav-item flex items-center space-x-2 px-2 py-2 rounded-lg transition text-xs {{ request()->routeIs('cashier.deposits.*') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-orange-50 hover:text-orange-600' }}" data-search="deposits">
                <i class="fas fa-arrow-down w-3 text-xs"></i><span>Deposits</span>
            </a>
            <a href="{{ route('cashier.withdrawals.index') }}" class="nav-item flex items-center space-x-2 px-2 py-2 rounded-lg transition text-xs {{ request()->routeIs('cashier.withdrawals.*') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-orange-50 hover:text-orange-600' }}" data-search="withdrawals">
                <i class="fas fa-arrow-up w-3 text-xs"></i><span>Withdrawals</span>
            </a>
            ...
            <a href="{{ route('cashier.reports.index') }}" class="nav-item flex items-center space-x-2 px-2 py-2 rounded-lg transition text-xs {{ request()->routeIs('cashier.reports.*') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-orange-50 hover:text-orange-600' }}" data-search="reports">
                <i class="fas fa-chart-bar w-3 text-xs"></i><span>Reports</span>
            </a>
            <a href="{{ route('cashier.notifications.index') }}" class="nav-item flex items-center space-x-2 px-2 py-2 rounded-lg transition text-xs {{ request()->routeIs('cashier.notifications.*') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-orange-50 hover:text-orange-600' }}" data-search="notifications">
                <i class="fas fa-bell w-3 text-xs"></i><span>Notifications</span>
            </a>
            <a href="{{ route('cashier.users.index') }}" class="nav-item flex items-center space-x-2 px-2 py-2 rounded-lg transition text-xs {{ request()->routeIs('cashier.users.*') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-orange-50 hover:text-orange-600' }}" data-search="users">
                <i class="fas fa-user-shield w-3 text-xs"></i><span>Users</span>
            </a>
            <a href="{{ route('cashier.settings.index') }}" class="nav-item flex items-center space-x-2 px-2 py-2 rounded-lg transition text-xs {{ request()->routeIs('cashier.settings.*') ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-orange-50 hover:text-orange-600' }}" data-search="settings">
        ...
        <div class="mt-4 pt-4 border-t border-blue-200">
            ...
            <a href="{{ route('cashier.profile') }}" class="nav-item flex items-center space-x-2 px-2 py-2 rounded-lg transition text-xs text-gray-700 hover:bg-orange-50 hover:text-orange-600">
        ...
        <div class="flex justify-center">
            <div class="w-80 space-y-2">
                ...
                <div class="flex gap-2 pt-1">
                    <a href="{{ route('cashier.profile') }}" @click="showProfileModal = false" 
