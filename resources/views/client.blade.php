            ...
            <div class="flex justify-between items-center">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-blue-200 text-sm">Personal Financial Management</p>
                    </div>
                </div>
                <div class="flex items-center space-x-4">
                    <div class="text-right">
                        <p class="text-sm text-blue-200">Welcome back</p>
                        <p class="font-semibold" x-text="userData.name">John Doe</p>
                    </div>
                    <button class="bg-blue-700 px-4 py-2 rounded hover:bg-blue-600">
