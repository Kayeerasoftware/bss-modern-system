...
@section('content')
<div class="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-purple-50 p-6" x-data="{ activeTab: {{ Js::from(request('tab', '')) }} }" x-effect="activeTab === '' && window.initShareholderFinancialCharts && window.initShareholderFinancialCharts()">
    <div class="mb-6">
        <div class="flex items-center gap-2 md:gap-4">
            ...
            <div>
                ...
                <p class="text-gray-600 text-xs md:text-sm font-medium">{{ $member->full_name }} - Shareholder Financial Dashboard</p>
            </div>
        </div>
    </div>
    ...
    <div x-show="activeTab === 'transactions'" x-cloak class="mb-6">
        ...
        <form method="GET" action="{{ route('shareholder.financial') }}" class="bg-white/90 rounded-2xl shadow-lg border border-indigo-100 p-3 mb-3">
            <input type="hidden" name="tab" value="transactions">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-2">
                <div class="md:col-span-3">
                    <input type="text" name="transactions_search" value="{{ request('transactions_search') }}" placeholder="Search transactions..." class="w-full px-3 py-2 text-xs border border-indigo-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-white">
                </div>
                ...
                <div class="md:col-span-2 flex gap-2">
                    ...
                    <a href="{{ route('shareholder.financial', ['tab' => 'transactions']) }}" class="px-3 py-2 text-xs bg-gray-100 text-gray-700 rounded-lg font-semibold text-center">Reset</a>
                </div>
            </div>
        </form>
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
            <div class="px-4 py-3 border-b bg-gray-50 flex items-center justify-between">
                ...
                <a href="{{ route('shareholder.transactions') }}" class="text-xs font-semibold text-purple-600 hover:underline">View all</a>
            </div>
            <div class="overflow-x-auto">
                <table class="min-w-full">
                    <thead class="bg-gradient-to-r from-purple-600 via-pink-600 to-purple-600">
                        ...
                        @forelse($transactions as $transaction)
                            <tr class="border-b hover:bg-purple-50/40">
                                ...
                                <td class="px-4 py-3 text-xs">
                                    <a href="{{ route('shareholder.transactions.show', $transaction->id) }}" class="text-purple-600 hover:underline font-semibold">View</a>
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="7" class="px-6 py-10 text-center text-sm text-gray-500">No transactions available.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
    ...
    <div x-show="activeTab === 'dividends'" x-cloak class="mb-6">
        ...
        <form method="GET" action="{{ route('shareholder.financial') }}" class="bg-white/90 rounded-2xl shadow-lg border border-yellow-100 p-3 mb-3">
            <input type="hidden" name="tab" value="dividends">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-2">
                <div class="md:col-span-3">
                    <input type="text" name="dividends_search" value="{{ request('dividends_search') }}" placeholder="Search dividends..." class="w-full px-3 py-2 text-xs border border-yellow-200 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent bg-white">
                </div>
                <div class="md:col-span-2">
                ...
                <div class="md:col-span-2 flex gap-2">
                    ...
                    <a href="{{ route('shareholder.financial', ['tab' => 'dividends']) }}" class="px-3 py-2 text-xs bg-gray-100 text-gray-700 rounded-lg font-semibold text-center">Reset</a>
                </div>
            </div>
        </form>
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
            <div class="px-4 py-3 border-b bg-gray-50 flex items-center justify-between">
                ...
                <a href="{{ route('shareholder.dividends.index') }}" class="text-xs font-semibold text-yellow-600 hover:underline">View all</a>
            </div>
            <div class="overflow-x-auto">
                <table class="min-w-full">
                    ...
                    <tbody class="bg-white">
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-6 py-10 text-center text-sm text-gray-500">No dividends available.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
    ...
    <div x-show="activeTab === 'shares'" x-cloak class="mb-6">
        ...
        <form method="GET" action="{{ route('shareholder.financial') }}" class="bg-white/90 rounded-2xl shadow-lg border border-teal-100 p-3 mb-3">
            <input type="hidden" name="tab" value="shares">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-2">
                <div class="md:col-span-4">
                    <input type="text" name="shares_search" value="{{ request('shares_search') }}" placeholder="Search shares..." class="w-full px-3 py-2 text-xs border border-teal-200 rounded-lg focus:ring-2 focus:ring-teal-500 bg-white">
                </div>
                <div class="md:col-span-2">
                ...
                <div class="md:col-span-2 flex gap-2">
                    ...
                    <a href="{{ route('shareholder.financial', ['tab' => 'shares']) }}" class="px-3 py-2 text-xs bg-gray-100 text-gray-700 rounded-lg font-semibold text-center">Reset</a>
                </div>
            </div>
        </form>
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
            <div class="px-4 py-3 border-b bg-gray-50 flex items-center justify-between">
                ...
                <a href="{{ route('shareholder.members') }}" class="text-xs font-semibold text-teal-600 hover:underline">View members</a>
            </div>
            <div class="overflow-x-auto">
                <table class="min-w-full">
                    ...
                    <tbody class="bg-white">
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="px-6 py-10 text-center text-sm text-gray-500">No shares available.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
    ...
    <div x-show="activeTab === 'loans'" x-cloak class="mb-6">
        ...
        <form method="GET" action="{{ route('shareholder.financial') }}" class="bg-white/90 rounded-2xl shadow-lg border border-pink-100 p-3 mb-3">
            <input type="hidden" name="tab" value="loans">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-2">
                <div class="md:col-span-4">
                    <input type="text" name="loans_search" value="{{ request('loans_search') }}" placeholder="Search loans..." class="w-full px-3 py-2 text-xs border border-pink-200 rounded-lg focus:ring-2 focus:ring-pink-500 bg-white">
                </div>
                <div class="md:col-span-2">
                ...
                <div class="md:col-span-2 flex gap-2">
                    ...
                    <a href="{{ route('shareholder.financial', ['tab' => 'loans']) }}" class="px-3 py-2 text-xs bg-gray-100 text-gray-700 rounded-lg font-semibold text-center">Reset</a>
                </div>
            </div>
        </form>
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
            <div class="px-4 py-3 border-b bg-gray-50 flex items-center justify-between">
                ...
                <a href="{{ route('shareholder.loans') }}" class="text-xs font-semibold text-pink-600 hover:underline">View all</a>
            </div>
            <div class="overflow-x-auto">
                <table class="min-w-full">
                    ...
                    <tbody class="bg-white">
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-6 py-10 text-center text-sm text-gray-500">No loans available.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
    ...
    <div x-show="activeTab === 'savings'" x-cloak class="mb-6">
        ...
        <form method="GET" action="{{ route('shareholder.financial') }}" class="bg-white/90 rounded-2xl shadow-lg border border-green-100 p-3 mb-3">
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-2">
                ...
                <div class="md:col-span-2 flex gap-2">
                    ...
                    <a href="{{ route('shareholder.financial', ['tab' => 'savings']) }}" class="px-3 py-2 text-xs bg-gray-100 text-gray-700 rounded-lg font-semibold text-center">Reset</a>
                </div>
            </div>
        </form>
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full">
                    ...
                    <tbody class="bg-white">
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-6 py-10 text-center text-sm text-gray-500">No savings transactions available.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
    ...
    <div x-show="activeTab === 'expenses'" x-cloak class="mb-6">
        ...
        <form method="GET" action="{{ route('shareholder.financial') }}" class="bg-white/90 rounded-2xl shadow-lg border border-red-100 p-3 mb-3">
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-2">
                ...
                <div class="md:col-span-2 flex gap-2">
                    ...
                    <a href="{{ route('shareholder.financial', ['tab' => 'expenses']) }}" class="px-3 py-2 text-xs bg-gray-100 text-gray-700 rounded-lg font-semibold text-center">Reset</a>
                </div>
            </div>
        </form>
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full">
                    ...
                    <tbody class="bg-white">
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-6 py-10 text-center text-sm text-gray-500">No expense transactions available.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
    ...
    <div x-show="activeTab === 'revenue'" x-cloak class="mb-6">
        ...
        <form method="GET" action="{{ route('shareholder.financial') }}" class="bg-white/90 rounded-2xl shadow-lg border border-emerald-100 p-3 mb-3">
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-2">
                ...
                <div class="md:col-span-2 flex gap-2">
                    ...
                    <a href="{{ route('shareholder.financial', ['tab' => 'revenue']) }}" class="px-3 py-2 text-xs bg-gray-100 text-gray-700 rounded-lg font-semibold text-center">Reset</a>
                </div>
            </div>
        </form>
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full">
                    ...
                    <tbody class="bg-white">
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-6 py-10 text-center text-sm text-gray-500">No revenue transactions available.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
    ...
    <div x-show="activeTab === 'assets'" x-cloak class="mb-6 space-y-4">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
            ...
            <form method="GET" action="{{ route('shareholder.financial') }}" class="bg-white/90 border-b border-blue-100 p-3">
                <input type="hidden" name="tab" value="assets">
                <div class="grid grid-cols-1 md:grid-cols-12 gap-2">
                    <div class="md:col-span-4">
                        <input type="text" name="assets_savings_search" value="{{ request('assets_savings_search') }}" placeholder="Search accounts..." class="w-full px-3 py-2 text-xs border border-blue-200 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white">
                    </div>
                    <div class="md:col-span-2">
                    ...
                    <div class="md:col-span-2 flex gap-2">
                        ...
                        <a href="{{ route('shareholder.financial', ['tab' => 'assets']) }}" class="px-3 py-2 text-xs bg-gray-100 text-gray-700 rounded-lg font-semibold text-center">Reset</a>
                    </div>
                </div>
            </form>
            <div class="overflow-x-auto">
                <table class="min-w-full">
                    ...
                    <tbody class="bg-white">
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-6 py-10 text-center text-sm text-gray-500">No savings accounts available.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
            ...
            <form method="GET" action="{{ route('shareholder.financial') }}" class="bg-white/90 border-b border-teal-100 p-3">
                <input type="hidden" name="tab" value="assets">
                <div class="grid grid-cols-1 md:grid-cols-12 gap-2">
                    <div class="md:col-span-6">
                        <input type="text" name="assets_shares_search" value="{{ request('assets_shares_search') }}" placeholder="Search certificates..." class="w-full px-3 py-2 text-xs border border-teal-200 rounded-lg focus:ring-2 focus:ring-teal-500 bg-white">
                    </div>
                    <div class="md:col-span-2">
    ...
    <div x-show="activeTab === 'liabilities'" x-cloak class="mb-6 space-y-4">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
            ...
            <form method="GET" action="{{ route('shareholder.financial') }}" class="bg-white/90 border-b border-pink-100 p-3">
                <input type="hidden" name="tab" value="liabilities">
                <div class="grid grid-cols-1 md:grid-cols-12 gap-2">
                    <div class="md:col-span-4">
                        <input type="text" name="liabilities_loans_search" value="{{ request('liabilities_loans_search') }}" placeholder="Search loans..." class="w-full px-3 py-2 text-xs border border-pink-200 rounded-lg focus:ring-2 focus:ring-pink-500 bg-white">
                    </div>
                    <div class="md:col-span-2">
                    ...
                    <div class="md:col-span-2 flex gap-2">
                        <button type="submit" class="flex-1 px-3 py-2 text-xs bg-gradient-to-r from-pink-600 to-red-600 text-white rounded-lg font-semibold">Filter</button>
                        <a href="{{ route('shareholder.financial', ['tab' => 'liabilities']) }}" class="px-3 py-2 text-xs bg-gray-100 text-gray-700 rounded-lg font-semibold text-center">Reset</a>
                    </div>
                </div>
            </form>
            <div class="overflow-x-auto">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
            ...
            <form method="GET" action="{{ route('shareholder.financial') }}" class="bg-white/90 border-b border-yellow-100 p-3">
                <input type="hidden" name="tab" value="liabilities">
                <div class="grid grid-cols-1 md:grid-cols-12 gap-2">
                    <div class="md:col-span-3">
                    ...
                    <div class="md:col-span-4">
                        <span class="text-xs text-gray-500 flex items-center h-full">Filters apply to pending dividends only</span>
                    </div>
                    <div class="md:col-span-2 flex gap-2">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full">
                    ...
                    <tbody class="bg-white">
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="px-6 py-10 text-center text-sm text-gray-500">No pending dividends available.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
...
@push('scripts')
<script>
function initShareholderFinancialCharts(force = false) {
    if (!window.Chart) {
    ...
    window.shareholderFinancialCharts = window.shareholderFinancialCharts || {};
    ...
    if (hasMonthlyData) {
        ...
        if (monthlyCanvas) {
            if (force && window.shareholderFinancialCharts.monthly) {
                window.shareholderFinancialCharts.monthly.destroy();
            }
            const monthlyCtx = monthlyCanvas.getContext('2d');
            window.shareholderFinancialCharts.monthly = new Chart(monthlyCtx, {
            type: 'line',
            data: {
    ...
    if (totalRevenue > 0) {
        ...
        if (revenueCanvas) {
            if (force && window.shareholderFinancialCharts.revenue) {
                window.shareholderFinancialCharts.revenue.destroy();
            }
            const revenueCtx = revenueCanvas.getContext('2d');
            window.shareholderFinancialCharts.revenue = new Chart(revenueCtx, {
            type: 'doughnut',
            data: {
...
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', function() { initShareholderFinancialCharts(true); });
} else {
    initShareholderFinancialCharts(true);
}
</script>
@endpush
