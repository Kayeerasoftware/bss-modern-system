<div class="mb-6">
    ...
    <div class="grid grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-green-50 p-4 rounded-lg">
            ...
            <p class="text-2xl font-bold text-green-600">{{ $deposits->count() }}</p>
        </div>
        <div class="bg-red-50 p-4 rounded-lg">
            <p class="text-sm text-gray-600">Withdrawals</p>
            <p class="text-2xl font-bold text-red-600">{{ $withdrawals->count() }}</p>
        </div>
...
<table class="w-full">
    ...
    <tbody>
        ...
        <tr class="border-b">
            <td class="px-4 py-3">{{ $transaction->transaction_number ?? $transaction->id ?? 'N/A' }}</td>
