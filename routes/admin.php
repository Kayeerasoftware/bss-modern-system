...
Route::prefix('admin')->name('admin.')->middleware(['web', 'auth', 'role:admin,ceo,td'])->group(function () {
    ...
    Route::post('/profile/picture', [\App\Http\Controllers\Admin\ProfileController::class, 'uploadProfilePicture'])->name('profile.picture');
    Route::post('/profile/preferences', [\App\Http\Controllers\Admin\ProfileController::class, 'updatePreferences'])->name('profile.preferences');
    ...
    Route::prefix('members')->name('members.')->group(function () {
        ...
        Route::get('/{id}/details', [MemberController::class, 'details'])->name('details');
        ...
        Route::get('/pictures/bulk-upload', function() {
            $members = \App\Models\Member::select('id', 'member_id', 'full_name', 'profile_picture')
                ->orderBy('full_name')
                ->get();
            return view('admin.members.bulk-picture-upload', compact('members'));
