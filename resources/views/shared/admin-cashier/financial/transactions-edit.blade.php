<div class="min-h-screen bg-gradient-to-br from-cyan-50 via-blue-50 to-indigo-50 p-3 md:p-6">
    ...
    <div class="flex items-center gap-3 mb-6">
        <a href="{{ route((request()->routeIs('cashier.*') ? 'cashier' : 'admin') . '.financial.transactions') }}" class="p-3 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:scale-105">
    ...
    <form action="{{ route((request()->routeIs('cashier.*') ? 'cashier' : 'admin') . '.financial.transactions.update', $transaction->id) }}" method="POST" class="max-w-5xl mx-auto">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
            ...
            <div class="p-6 md:p-8 space-y-8">
                ...
                <div class="flex flex-col sm:flex-row justify-end gap-4 pt-6 border-t-2 border-gray-100">
                    <a href="{{ route((request()->routeIs('cashier.*') ? 'cashier' : 'admin') . '.financial.transactions') }}" class="px-8 py-3 border-2 border-gray-300 text-gray-700 rounded-xl hover:bg-gray-50 transition-all font-bold text-center transform hover:scale-105">
