<div class="min-h-screen bg-gradient-to-br from-green-50 via-teal-50 to-blue-50 p-3 md:p-6">
    ...
    <div class="flex items-center justify-between gap-3 mb-6">
        <div class="flex items-center gap-3">
            <a href="{{ route((request()->routeIs('cashier.*') ? 'cashier' : 'admin') . '.loan-applications.index') }}" class="p-3 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:scale-105">
        ...
        <a href="{{ route((request()->routeIs('cashier.*') ? 'cashier' : 'admin') . '.loan-applications.edit', $application->id) }}" class="px-4 py-2 bg-gradient-to-r from-yellow-600 to-orange-600 text-white rounded-xl hover:shadow-xl transition-all font-bold transform hover:scale-105">
...
<div id="approveModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white rounded-2xl p-8 max-w-md w-full mx-4 shadow-2xl">
        ...
        <form action="{{ route((request()->routeIs('cashier.*') ? 'cashier' : 'admin') . '.loan-applications.approve', $application->id) }}" method="POST">
            @csrf
            <div class="mb-6">
...
<div id="rejectModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white rounded-2xl p-8 max-w-md w-full mx-4 shadow-2xl">
        ...
        <form action="{{ route((request()->routeIs('cashier.*') ? 'cashier' : 'admin') . '.loan-applications.reject', $application->id) }}" method="POST">
            @csrf
            <div class="mb-6">
                <label class="flex items-center gap-2 text-sm font-bold text-gray-700 mb-2">
