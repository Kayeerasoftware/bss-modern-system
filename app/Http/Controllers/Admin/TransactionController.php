...
class TransactionController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.financial.transactions', compact('transactions', 'categories', 'categoryCounts'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.financial.transactions-create', compact('members', 'memberSummaries'));
    }
    ...
    public function storeDeposit(Request $request, TransactionPostingService $postingService)
    {
        $request->merge([
            'type' => 'deposit',
            'category' => $request->input('category', 'savings_deposit'),
    ...
    public function storeWithdrawal(Request $request, TransactionPostingService $postingService)
    {
        $request->merge([
            'type' => 'withdrawal',
            'category' => $request->input('category', 'savings_withdrawal'),
            'payment_method' => $request->input('payment_method', 'cash'),
            'transaction_date' => $request->input('transaction_date', now()->toDateString()),
        ]);
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.financial.transactions')->with('success', 'Transaction deleted successfully');
    }
