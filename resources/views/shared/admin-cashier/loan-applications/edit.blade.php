<div class="min-h-screen bg-gradient-to-br from-green-50 via-teal-50 to-blue-50 p-3 md:p-6">
    ...
    <form action="{{ route((request()->routeIs('cashier.*') ? 'cashier' : 'admin') . '.loan-applications.update', $application->id) }}" method="POST" class="max-w-5xl mx-auto">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
            ...
            <div class="p-6 md:p-8 space-y-8">
                ...
                <div class="flex flex-col sm:flex-row justify-end gap-4 pt-6 border-t-2 border-gray-100">
                    <a href="{{ route((request()->routeIs('cashier.*') ? 'cashier' : 'admin') . '.loan-applications.index') }}" class="px-8 py-3 border-2 border-gray-300 text-gray-700 rounded-xl hover:bg-gray-50 transition-all font-bold text-center transform hover:scale-105">
