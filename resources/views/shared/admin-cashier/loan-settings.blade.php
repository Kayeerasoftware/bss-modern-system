<div class="min-h-screen bg-gradient-to-br from-yellow-50 via-orange-50 to-red-50 p-3 md:p-6">
    ...
    <div class="mb-6">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
            ...
            <a href="{{ route((request()->routeIs('cashier.*') ? 'cashier' : 'admin') . '.loan-applications.index') }}" class="px-6 py-3 bg-gradient-to-r from-gray-600 to-gray-700 text-white rounded-xl hover:shadow-2xl transition-all duration-300 font-bold flex items-center gap-2 transform hover:scale-105">
    ...
    <form action="{{ route((request()->routeIs('cashier.*') ? 'cashier' : 'admin') . '.loan-settings.update') }}" method="POST">
        @csrf
        @method('PUT')
