    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 mb-6">
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100 transform hover:scale-105 transition-all">
            <div class="bg-gradient-to-r from-indigo-600 to-purple-600 p-4 text-center">
                ...
                <h3 class="text-white text-sm font-bold">Projects</h3>
            </div>
            <div class="p-3">
                <form action="{{ route('admin.reports.generate') }}" method="POST">
                    @csrf
                    ...
                    <input type="hidden" name="to_date" value="{{ date('Y-m-d') }}">
                    <input type="hidden" name="format" value="html">
                    <button type="submit" class="w-full px-3 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg hover:shadow-lg transition-all text-xs font-bold">
                        <i class="fas fa-download mr-1"></i>Generate
                    </button>
                </form>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100 transform hover:scale-105 transition-all">
            <div class="bg-gradient-to-r from-red-600 to-pink-600 p-4 text-center">
                <i class="fas fa-clipboard-list text-white text-2xl mb-2"></i>
                <h3 class="text-white text-sm font-bold">Audit</h3>
            </div>
            <div class="p-3">
                <form action="{{ route('admin.reports.generate') }}" method="POST">
                    @csrf
