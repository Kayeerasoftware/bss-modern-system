...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (Schema::hasTable('members') && !DB::selectOne("SELECT 1 FROM information_schema.statistics WHERE table_schema = DATABASE() AND table_name = 'members' AND index_name = 'idx_members_account_number' LIMIT 1")) {
