<div x-data="{ showAdvancedMobileCharts: false }" class="space-y-4">
    <div class="mt-5 grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        <div class="hidden rounded-2xl border border-slate-200 bg-white p-4 shadow-sm md:block" :class="showAdvancedMobileCharts ? '!block' : 'hidden md:block'">
    ...
    <div class="md:hidden">
        <button
            type="button"
            @click="showAdvancedMobileCharts = !showAdvancedMobileCharts"
            class="w-full rounded-lg border border-slate-200 bg-white px-4 py-2 text-xs font-semibold text-slate-700 shadow-sm"
            x-text="showAdvancedMobileCharts ? 'Show fewer charts' : 'Show advanced charts'">
        </button>
    </div>
