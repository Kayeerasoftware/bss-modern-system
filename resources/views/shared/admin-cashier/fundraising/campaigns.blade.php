<div class="mb-6 flex justify-between items-center">
    ...
    <a href="{{ route((request()->routeIs('cashier.*') ? 'cashier' : 'admin') . '.fundraising.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700">
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route((request()->routeIs('cashier.*') ? 'cashier' : 'admin') . '.fundraising.show', $campaign->id) }}" class="text-blue-600 hover:text-blue-900">View</a>
        </div>
    </div>
    @empty
