                            ...
                            <div class="flex items-center gap-4">
                                <div class="relative w-12 h-12 rounded-full overflow-hidden shrink-0">
                                    @if($member->profile_picture_url)
                                        <img src="{{ $member->profile_picture_url }}" onerror="this.onerror=null;this.src='{{ asset('images/default-avatar.svg') }}';" class="w-12 h-12 rounded-full object-cover ring-2 ring-blue-500 ring-offset-2 shrink-0">
                                    @else
                                        <div class="w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-cyan-600 flex items-center justify-center ring-2 ring-blue-500 ring-offset-2 shrink-0">
