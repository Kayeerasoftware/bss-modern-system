<div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2 md:gap-3">
    ...
    <div class="bg-gradient-to-r from-emerald-50 to-emerald-100 rounded-lg shadow-md p-2 md:p-3 hover:shadow-lg hover:scale-105 transition-all duration-300 border border-emerald-200">
        <div class="flex items-center gap-2 md:gap-3">
            <div class="bg-gradient-to-br from-emerald-500 to-emerald-600 p-2 md:p-2.5 rounded-lg shadow">
                <i class="fas fa-piggy-bank text-white text-base md:text-lg"></i>
            </div>
            <div class="flex-1">
                <p class="text-xs md:text-sm text-gray-600 font-semibold leading-tight">Total Savings</p>
                <h3 class="text-xl md:text-3xl font-bold text-gray-900 leading-tight">{{ number_format($stats['totalSavings']/1000000, 1) }}M <span class="text-xs text-gray-500 font-medium">UGX</span></h3>
            </div>
        </div>
    </div>
    ...
    <div class="bg-gradient-to-r from-red-50 to-red-100 rounded-lg shadow-md p-2 md:p-3 hover:shadow-lg hover:scale-105 transition-all duration-300 border border-red-200">
        <div class="flex items-center gap-2 md:gap-3">
            ...
            <div class="flex-1">
                <p class="text-xs md:text-sm text-gray-600 font-semibold leading-tight">Total Loan</p>
                <h3 class="text-xl md:text-3xl font-bold text-gray-900 leading-tight">{{ number_format($stats['totalLoan']/1000000, 1) }}M <span class="text-xs text-gray-500 font-medium">UGX</span></h3>
            </div>
        </div>
    </div>
    ...
    <div class="bg-gradient-to-r from-cyan-50 to-cyan-100 rounded-lg shadow-md p-2 md:p-3 hover:shadow-lg hover:scale-105 transition-all duration-300 border border-cyan-200">
        <div class="flex items-center gap-2 md:gap-3">
            ...
            <div class="flex-1">
                <p class="text-xs md:text-sm text-gray-600 font-semibold leading-tight">Net Balance</p>
                <h3 class="text-xl md:text-3xl font-bold {{ $stats['netBalance'] >= 0 ? 'text-green-600' : 'text-red-600' }} leading-tight">{{ number_format($stats['netBalance']/1000000, 1) }}M <span class="text-xs text-gray-500 font-medium">UGX</span></h3>
            </div>
        </div>
    </div>
